...
// These filter will be then used to test whether a key is a member of the set.
...
type Filter interface {
	...
	//
	// The filter is filters generated by the filter generator.
...
type FilterGenerator interface {
	...
	// use. The key should not be modified directly, doing so may cause
	// undefined results.
	Add(key []byte)
