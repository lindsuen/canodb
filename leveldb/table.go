...
import (
	...
	"github.com/lindsuen/canodb/leveldb/table"
...
// Returns true if given key is before the smallest key of this table.
...
// Returns true if i is the smallest key is less than j.
...
func (tf tFiles) getOverlaps(dst tFiles, icmp *iComparer, umin, umax []byte, overlapped bool) tFiles {
	...
	if !overlapped {
		var begin, end int
		// Determine the beginning index of the overlapped file
		if umin != nil {
